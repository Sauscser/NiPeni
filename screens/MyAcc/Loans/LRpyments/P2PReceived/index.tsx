...
import { getCompany, getSMAccount,  listLoanRepayments,  listNonLoans,  listSMAccounts, vwMyRecMny } from '../../../../../src/graphql/queries';
      ...
      style= {{width:"100%"}}
        ...
        ListHeaderComponent={() => (
          <>
            ...
            <Text style={styles.label}>Received Pal LP </Text>
