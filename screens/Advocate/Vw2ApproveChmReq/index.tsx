...
import NonLnSent from "../../../components/Advocate/VwChm2Approve";



import { getCompany, getSMAccount, listReqLoanChamas } from '../../../src/graphql/queries';
            ...
            try {
              const Lonees:any = await client.graphql({
                ...
                variables: {
                  ...
                  const clientz = Lonees.data.listReqLoanChamas.items
                  setRecvrs(clientz);
