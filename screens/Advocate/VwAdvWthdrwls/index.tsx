...
import {View, Text, FlatList, Alert, StyleSheet, Button, TouchableOpacity} from 'react-native';
...
import { getCompany, getSMAccount, listAdvocateWithdrawals  } from '../../../src/graphql/queries';
      ...
      try {
        ...
        const fetchLoanees = async () => {
            ...
            try {
              ...
              const dls = Lonees.data.listAdvocateWithdrawals.items
                  setRecvrs(dls);
         ...
         showsVerticalScrollIndicator={false}
          ListHeaderComponent={() => (
            <View style={styles.headerContainer}>
              <Text style={styles.headerText}> My Withdrawals</Text>
