...
const CredSlrCvLnStts = (props:ChmCvLnSttusRec) => {
   ...
   const SndChmMmbrMny = () => {
      navigation.navigate ("VwMyPalLoaneesDtld", {loanID})
   }

   const VwRpayments = () => {
      navigation.navigate ("CredP2PReceived", {loanID})
   }

   const Blacklist = () => {
      navigation.navigate ("BLCredPal2Pal", {loanID})
   }

   const WaivePal2Pal = () => {
      navigation.navigate ("WaivePal2Pal", {loanID})
   }
